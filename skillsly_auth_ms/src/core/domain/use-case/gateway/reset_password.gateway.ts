...
export default interface ResetPasswordGateway extends FindOne<UserQueryModel, UserDTO>, PartialUpdateByParams<UserDTO, PartialUserUpdateDTO, UserQueryModel> {
