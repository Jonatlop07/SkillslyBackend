export class UserDITokens {
  ...
  public static readonly CreateFollowUserRequestService: unique symbol = Symbol('CreateFollowUserRequestService');
  public static readonly DeleteFollowUserRequestService: unique symbol = Symbol('DeleteFollowUserRequestService');
  public static readonly UpdateFollowUserRequestService: unique symbol = Symbol('UpdateFollowUserRequestService');
  public static readonly QueryFollowRelationshipsService: unique symbol = Symbol('QueryFollowRelationshipsService');
}
